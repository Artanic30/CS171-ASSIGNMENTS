...
int main()
{
	...
	Eigen::Vector2i filmRes(2000, 2000);
	...
	/*
    std::string obj_4_filePos("../resources/light.obj");
    Eigen::Vector3f obj_4_color(1,1,1);
    Eigen::Affine3f obj_4_transform;
    obj_4_transform = Eigen::Translation3f(0, 5.8, -5) * Eigen::Scaling(0.8f);
    TriangleMesh mesh_light(obj_4_color, obj_4_filePos);
    mesh_light.applyTransformation(obj_4_transform);
    mesh_light.buildUniformGrid();
    */
    ...
    // mesh_light.material = diffuseMat;

    backWall.set_type(1);
    leftWall.set_type(1);
    floor.set_type(1);
    ceiling.set_type(1);
    rightWall.set_type(1);
    // mesh_light.set_type(2);
